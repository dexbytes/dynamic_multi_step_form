...
class RadioButtonConfiguration {
  ...
  late LabelAndOptionsAlignment _labelAndRadioButtonAlign =
      LabelAndOptionsAlignment.horizontal;

  //Radio buttons alignment
  late LabelAndOptionsAlignment _radioButtonsAlign =
      LabelAndOptionsAlignment.horizontal;
  ...
  RadioButtonConfiguration(
    ...
    _labelAndRadioButtonAlign =
        labelAndRadioButtonAlign ?? _labelAndRadioButtonAlign;
  ...
  RadioButtonConfiguration setConfiguration(
      {TextStyle? textStyle,
      TextStyle? optionTextStyle,
      LabelAndOptionsAlignment? labelAndRadioButtonAlign,
      LabelAndOptionsAlignment? radioButtonsAlign,
