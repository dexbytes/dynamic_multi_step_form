/// QrScannerTextFieldModel model
class QrScannerTextFieldModel {
  String? elementType;
  ...
  QrScannerTextFieldModel.fromJson(Map<String, dynamic> json) {
...
class ElementConfig {
  ...
  ElementConfig.fromJson(Map<String, dynamic> json) {
    ...
    pickDateFromCalender = json.containsKey('pickDateFromCalender')
        ...
        : false;
    isQrCodeScanner =
        json.containsKey('isQrCodeScanner') ? json['isQrCodeScanner'] : false;
  }
